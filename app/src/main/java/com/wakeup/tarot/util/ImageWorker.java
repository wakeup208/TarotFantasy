...
public abstract class ImageWorker {
    ...
    private static final int MESSAGE_CLEAR_MEM_CACHE = 1;
    private static final int MESSAGE_CLEAR_DISK_CACHE = 2;
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        if (mImageCache != null) {
            ...
            // Get Bitmap from Disk cache if need
            if (value == null) {
            	Bitmap bm = mImageCache.getBitmapFromDiskCache(String.valueOf(data));
            	if (bm != null) {
        ...
        protected Void doInBackground(Object... params) {
            switch ((Integer)params[0]) {
                ...
                case MESSAGE_CLEAR_MEM_CACHE:
                    ...
                    break;
                case MESSAGE_CLEAR_DISK_CACHE:
                    clearDiskCacheInternal();
                    break;
    ...
    public void clearDiskCache() {
        new CacheAsyncTask().execute(MESSAGE_CLEAR_DISK_CACHE);
    }
